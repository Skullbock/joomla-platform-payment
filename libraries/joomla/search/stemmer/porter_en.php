...
/**
 * Porter English stemmer class for the Joomla search package.
 *
 ...
 * @since       12.1
 */
class JSearchStemmerStemmerPorter_En extends JSearchStemmer
{
	/**
	 * @var    string  Regex for matching a consonant.
	 * @since  12.1
	 */
	protected static $regexConsonant = '(?:[bcdfghjklmnpqrstvwxz]|(?<=[aeiou])y|^y)';

	/**
	 * @var    string  Regex for matching a vowel.
	 * @since  12.1
	 */
	protected static $regexVowel = '(?:[aeiou]|(?<![aeiou])y)';
	 ...
	 * @since   12.1
	 */
	protected static function step1ab($word)
	{
	    // Part a
	    if (substr($word, -1) == 's') {
	 ...
	 * @since   12.1
	 */
	protected static function replace(&$str, $check, $repl, $m = null)
	{
	    $len = 0 - strlen($check);
	 ...
	 * @since   12.1
	 */
	protected static function m($str)
	{
	 ...
	 * @since   12.1
	 */
	protected static function doubleConsonant($str)
	{
	    $c = self::$regexConsonant;
	 ...
	 * @since   12.1
	 */
	protected static function cvc($str)
	{
	    $c = self::$regexConsonant;
	    $v = self::$regexVowel;
