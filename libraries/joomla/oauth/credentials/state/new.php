 ...
 * @since       12.1
 */
class JOAuthCredentialsStateNew extends JOAuthCredentialsState
{
	/**
	...
	public function initialize($clientKey, $callbackUrl)
	{
		...
		$this->properties['callback_url'] = $callbackUrl;
		$this->properties['client_key'] = $clientKey;
		$this->properties['key'] = $this->randomKey();
		$this->properties['secret'] = $this->randomKey(true);
		$this->properties['type'] = JOAuthCredentials::TEMPORARY;

		// Persist the object in the database.
		$this->create();

		return new JOAuthCredentialsStateTemporary($this->db, $this->properties);
	}
