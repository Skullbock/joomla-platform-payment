...
/**
 * OAuth Authorized Credentials class for the Joomla Platform
 *
 * @package     Joomla.Platform
 * @subpackage  OAuth
 * @since       12.1
 */
class JOAuthCredentialsStateAuthorized extends JOAuthCredentialsState
{
	/**
	...
	public function convert()
	{
		...
		$this->properties['type'] = JOAuthCredentials::TOKEN;

		// Persist the object in the database.
		$this->update();

		return new JOAuthCredentialsStateToken($this->db, $this->properties);
	}
