 ...
 * @since       12.1
 */
class JOAuthCredentialsStateTemporary extends JOAuthCredentialsState
{
	/**
	...
	public function authorize($resourceOwnerId)
	{
		...
		$this->properties['type'] = JOAuthCredentials::AUTHORIZED;

		// Persist the object in the database.
		$this->update();

		return new JOAuthCredentialsStateAuthorized($this->db, $this->properties);
	}
	...
	public function deny()
	{
		...
		return new JOAuthCredentialsStateDenied($this->db);
	}
